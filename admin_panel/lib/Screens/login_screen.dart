            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.only(
                        right: 30.0), // Right padding for space between list and divider
                    child: Column(
                      ...
                      children: [
                        ...
                        Image.asset(
                          ...
                          width: screenWidth * 0.5, // Adjusted width to fit within the screen
                        ...
                        _buildFeatureRow(Icons.local_florist, 'Organic Groceries'),
                        const SizedBox(height: 20), // Spacing between items
                        _buildFeatureRow(Icons.restaurant, 'Whole foods and vegetables'),
                ...
                Expanded(
                  flex: 3,
                  child: Padding(
                    padding: const EdgeInsets.only(left: 30.0), // Left padding to space from divider
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: const Color(0xFFB8DABA), // Button color similar to the image
