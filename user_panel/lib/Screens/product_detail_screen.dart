...
class ProductDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const ReviewPage(cartItems: [],),
                            ),
                          );
                        },
      ...
      // Inside your ProductDetailScreen widget:
      bottomNavigationBar: Padding(
        ...
        child: ElevatedButton(
          onPressed: () async {
            ...
            // Add the CartItem to Firestore with the userId and timestamp
            await FirebaseFirestore.instance.collection('cart').add({
              ...cartItem.toMap(),
              'userId': userId, // Add userId to the cart document
              'updatedAt': FieldValue.serverTimestamp(), // Add server timestamp
            });
